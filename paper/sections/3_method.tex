...
Additional pseudocode-level implementation details for C2 actions, residual attribution, renderer assumptions, and C5 thresholds are provided in \cref{app:implementation}.
