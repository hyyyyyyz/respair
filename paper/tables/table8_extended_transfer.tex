...
\centering
\scriptsize
\caption{Extended procedural noisy mesh transfer (PG-enh1). Two of ten cases trigger acceptance; the others roll back and deploy the baseline atlas. Real Trellis-3D / GET3D / DreamFusion outputs were not available at submission time and are listed in the limitations.}
